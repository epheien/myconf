...
local function setup_lualine() -- {{{
  local theme = {
    normal = {
      a = { fg = '#282828', bg = '#e0e000' }, -- 模式
      b = { fg = '#282828', bg = '#8ac6f2' }, -- 文件
      c = { fg = "#665c54", bg = "NONE" }, -- 填充色
    },
    insert = { a = { fg = '#282828', bg = '#95e454' } },
    terminal = { a = { fg = '#282828', bg = '#95e454' } },
    visual = { a = { fg = '#282828', bg = '#f2c68a' } },
    replace = { a = { fg = '#282828', bg = '#e5786d' } },
