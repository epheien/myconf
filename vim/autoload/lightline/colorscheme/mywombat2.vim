" =============================================================================
" Filename: autoload/lightline/colorscheme/mywombat.vim
" Author: itchyny (mod by eph)
" License: MIT License
...
let s:base02_orig = [ '#444444 ', 238 ]
let s:base02 = [ '282828 ', 235 ]
...
let s:p.normal.left = [ [ s:base02_orig, s:blue ], [ s:base3, s:base01 ] ]
...
let s:p.tabline.middle = [ [ s:base2, s:base02_orig ] ]
