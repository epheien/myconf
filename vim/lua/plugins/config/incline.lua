...
local function setup_incline()
  ...
  vim.api.nvim_set_hl(
    0,
    'InclineNormalMode',
    { fg = '#282828', bg = '#E0E000', ctermfg = 235, ctermbg = 184 }
  )
    ...
    render = function(props)
      ...
      if active then
        ...
        trail_icon = {
          trail_glyph,
          guibg = guibg,
          guifg = InclineNormal.guibg,
          ctermbg = ctermbg,
          ctermfg = InclineNormal.ctermbg,
        }
        ...
        trail_icon = {
          trail_glyph,
          guibg = guibg,
          guifg = InclineNormalNC.guibg,
          ctermbg = ctermbg,
          ctermfg = InclineNormalNC.ctermbg,
        }
      end
      if mod ~= '' then
        mod = ' ' .. mod
