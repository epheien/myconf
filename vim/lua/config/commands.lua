...
vim.api.nvim_create_user_command('StopRefreshStatusTables', function()
  vim.call('myrc#StopRefreshStatusTables')
end, { nargs = 0 })
...
vim.api.nvim_create_user_command('Base46Compile', function()
  ...
  require('base46').compile(
    vim.fs.joinpath(vim.fn.stdpath('config') --[[@as string]], 'plugpack/onedark-nvchad/lua/onedark-nvchad/soft')
  )
end, {})
