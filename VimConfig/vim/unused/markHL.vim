...
"  
"  USAGE:
"  <F2>		Turn on highlighting for all lines with markers on them
"  <F3>		Turn off the highlighting for marked lines
...
hi Marks guifg=white guibg=RoyalBlue3 ctermfg=0 ctermbg=4
...
nmap <F2> :call HLMarks("Marks")<CR>
nmap <F3> :call clearmatches()<CR>
