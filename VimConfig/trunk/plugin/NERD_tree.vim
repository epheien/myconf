...
call s:initVariable("g:NERDTreeMapHelp", "<F1>")
call s:initVariable("g:NERDTreeMapJumpFirstChild", "K")
call s:initVariable("g:NERDTreeMapJumpLastChild", "J")
"MOD
"call s:initVariable("g:NERDTreeMapJumpNextSibling", "<C-j>")
call s:initVariable("g:NERDTreeMapJumpNextSibling", "<C-n>")
call s:initVariable("g:NERDTreeMapJumpParent", "p")
"MOD
"call s:initVariable("g:NERDTreeMapJumpPrevSibling", "<C-k>")
call s:initVariable("g:NERDTreeMapJumpPrevSibling", "<C-p>")
...
function! s:setupSyntaxHighlighting()
    ...
    syn match treeClosable #[|`]\~#hs=s+1 contains=treePart
    syn match treeOpenable #[|`]+#hs=s+1 contains=treePart
    ...
    syn match treeFile  #`-.*# contains=treeLink,treePart,treeRO,treePartFile,treeBookmark,treeExecFile
    syn match treeNonText '^<'
    syn match treeCWD #^[/<].*$# contains=treeNonText
    ...
    hi def link treeNonText NonText
