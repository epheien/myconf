...
"    an 1.120  ToolBar.FindNext		n
  ...
  "an <silent> icon=build 1.220 ToolBar.BuildActiveProject 
		"\:call g:BuildActiveProject()<CR>
  "tmenu ToolBar.BuildActiveProject	Build Active Project
  "an <silent> icon=clean 1.230 ToolBar.CleanActiveProject 
		"\:call g:CleanActiveProject()<CR>
  "tmenu ToolBar.CleanActiveProject	Clean Active Project
  "an <silent> icon=execute 1.240 ToolBar.RunActiveProject	
		"\:call g:RunActiveProject()<CR>
